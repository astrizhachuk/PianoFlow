...
- 🔄 Планируется реализация MIDI-подключения (см. [Сценарии отслеживания состояния подключения MIDI-клавиатуры](../uc/MIDI_KEYBOARD_CONNECTION_STATE.md))

## Связанные документы

- [Сценарии отслеживания состояния подключения MIDI-клавиатуры](../uc/MIDI_KEYBOARD_CONNECTION_STATE.md) — описание сценариев отслеживания состояния подключения MIDI-клавиатуры
