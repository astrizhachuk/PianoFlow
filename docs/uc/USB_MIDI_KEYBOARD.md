...
6. Система обрабатывает уведомление о подключении через UC-002
...
5. Система обрабатывает уведомление о подключении через UC-002
...
5. Система обрабатывает уведомление об отключении через UC-002
...
3. Система обрабатывает ошибку через UC-002
...
#### A1: Критическая ошибка при обработке ошибки
1. Система получает ошибку, но не может её обработать (критическая ситуация)
...
2. ✅ Сообщения отображаются на русском языке
