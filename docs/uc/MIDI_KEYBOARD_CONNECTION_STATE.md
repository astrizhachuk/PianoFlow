...
Данный документ описывает сценарии использования функционала отслеживания состояния подключения MIDI-клавиатуры к Android-устройству, включая информирование пользователя. Документ предназначен для:
